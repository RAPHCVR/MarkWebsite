  ...
  return {
    ...
    "@graph": [
      ...
      },
      {
        ...
        primaryImageOfPage: {
          "@type": "ImageObject",
          url: absoluteUrl(siteConfig.searchImage),
          width: siteConfig.searchImageWidth,
          height: siteConfig.searchImageHeight,
        },
        thumbnailUrl: absoluteUrl(siteConfig.searchImage),
      },
