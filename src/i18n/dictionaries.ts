...
export const dictionaries = {
  en: {
    ...
    contact: {
      ...
      directTitle: "Direct legal contact",
      directBody:
        "For formal support, refunds or legal requests, reveal the domain email and phone after anti-spam verification.",
  ...
  fr: {
    ...
    socials: {
      ...
      items: {
        ...
        collabs: { label: "Collabs", handle: "formulaire sécurisé", description: "Campagnes, shootings, promos et demandes pro.", cta: "Ouvrir le formulaire" },
    ...
    contact: {
      ...
      directTitle: "Contact légal direct",
      directBody:
        "Pour le support formel, les remboursements ou les demandes légales, révèle l'email du domaine et le téléphone après vérification anti-spam.",
  ...
  ru: {
    ...
    socials: {
      ...
      items: {
        ...
        collabs: { label: "Коллаборации", handle: "защищенная форма", description: "Кампании, съемки, промо и деловые запросы.", cta: "Открыть форму" },
    ...
    contact: {
      ...
      directTitle: "Прямой юридический контакт",
      directBody:
        "Для формальной поддержки, возвратов или юридических запросов покажи email домена и телефон после антиспам-проверки.",
