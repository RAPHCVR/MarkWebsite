...
const linksCopy: Record<Locale, LinksCopy> = {
  en: {
    ...
    profile: "Official links, access passes and Telegram support.",
    officialLinks: "Official links",
    accessTitle: "Access passes",
    accessBody: "Start checkout from the site. Delivery stays private and time-limited.",
    accessMeta: "site delivery",
    supportTitle: "Need help?",
    supportBody: "Use Marky Concierge for order support or private request tickets.",
    supportCta: "Open concierge",
    safetyTitle: "Official accounts only",
    safetyItems: [
      "Payments start from markshnaknaks.com.",
      "Delivery links are private and time-limited.",
      "Private requests go through Marky Concierge.",
    ],
    fullSite: "Open full site",
    productTitles: {
      "cosplay-starter-pack": "Digital Access",
      "soft-catboy-drop": "Premium Membership",
      "vip-bundle": "VIP Access",
    },
    actions: {
  ...
  fr: {
    eyebrow: "Hub officiel",
    profile: "Liens officiels, passes d'acces et support Telegram.",
    officialLinks: "Liens officiels",
    accessTitle: "Passes d'acces",
    accessBody: "Lance le paiement depuis le site. La livraison reste privee et limitee dans le temps.",
    accessMeta: "livraison site",
    supportTitle: "Besoin d'aide ?",
    supportBody: "Utilise Marky Concierge pour le support commande ou les tickets de requete privee.",
    supportCta: "Ouvrir le concierge",
    safetyTitle: "Comptes officiels uniquement",
    safetyItems: [
      "Les paiements commencent sur markshnaknaks.com.",
      "Les liens de livraison sont prives et limites dans le temps.",
      "Les requetes privees passent par Marky Concierge.",
    ],
    fullSite: "Ouvrir le site",
    productTitles: {
      "cosplay-starter-pack": "Acces numerique",
      "soft-catboy-drop": "Membership premium",
      "vip-bundle": "Acces VIP",
    },
    actions: {
      passes: "Passes d'acces",
      telegram: "Telegram",
      support: "Support",
    },
  },
  ru: {
    ...
    profile: "Официальные ссылки, доступы и поддержка в Telegram.",
    officialLinks: "Официальные ссылки",
    accessTitle: "Цифровые доступы",
    accessBody: "Начинай оплату с сайта. Доставка остается приватной и ограниченной по времени.",
    accessMeta: "доставка на сайте",
    supportTitle: "Нужна помощь?",
    supportBody: "Используй Marky Concierge для поддержки заказов и приватных запросов.",
    supportCta: "Открыть concierge",
    safetyTitle: "Только официальные аккаунты",
    safetyItems: [
      "Оплата начинается на markshnaknaks.com.",
      "Ссылки доставки приватные и временные.",
      "Приватные запросы проходят через Marky Concierge.",
    ],
    fullSite: "Открыть сайт",
    productTitles: {
      "cosplay-starter-pack": "Цифровой доступ",
      "soft-catboy-drop": "Premium доступ",
      "vip-bundle": "VIP доступ",
    },
    actions: {
      passes: "Доступы",
      telegram: "Telegram",
