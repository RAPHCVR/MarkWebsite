      ...
      <div className="flex min-h-16 items-center justify-between gap-4 rounded-[1.75rem] border border-white/80 bg-white/78 px-4 shadow-[0_18px_50px_rgba(190,24,93,0.12)] backdrop-blur-xl sm:px-5">
        ...
        <nav className="hidden items-center gap-1 md:flex" aria-label="Main navigation">
          {[
            ...
            <a
              key={label}
              href={href}
              className="rounded-full px-4 py-2 text-sm font-black text-rose-950/70 transition hover:bg-pink-50 hover:text-pink-600 focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-pink-200"
            >
              {label}
            </a>
          ))}
        ...
        <div className="flex items-center gap-2">
          <a
            ...
            className="hidden size-10 items-center justify-center rounded-full border border-pink-100 bg-white/70 text-[var(--brand-color)] transition hover:border-pink-300 hover:bg-pink-50 focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-pink-200 sm:flex"
